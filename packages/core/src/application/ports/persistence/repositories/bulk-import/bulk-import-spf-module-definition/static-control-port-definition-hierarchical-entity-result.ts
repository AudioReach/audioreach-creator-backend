...
/**
 * Hierarchical result for Static Control Port Definition entity (leaf node).
 */
export class StaticControlPortDefinitionHierarchicalEntityResult extends BaseHierarchicalEntityResult<BaseInsertError> {
