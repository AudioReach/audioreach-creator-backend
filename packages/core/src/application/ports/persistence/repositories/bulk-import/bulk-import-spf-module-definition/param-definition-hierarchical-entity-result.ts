...
/**
 * Hierarchical result for Param Definition entity (leaf node).
 */
export class ParamDefinitionHierarchicalEntityResult extends BaseHierarchicalEntityResult<BaseInsertError> {
