...
/**
 * Hierarchical result for VCPM Parameter Definition entity (leaf node).
 * VcpmParameterDefinition extends ParamDefinition with additional defaultData property.
 */
export class VcpmParameterDefinitionHierarchicalEntityResult extends BaseHierarchicalEntityResult<BaseInsertError> {
