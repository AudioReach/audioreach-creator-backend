  ...
  .object({
    AllocatedIntents: z
      .object({
        ...
        intents: z
          .array(IntentItemSchema)
          .describe('Allocated intent IDs on the port'),
      })
    ...
    SupportedIntents: z
      .object({
        ...
        intents: z
          .array(IntentItemSchema)
          .describe(
            'Union of supported intents from all module endpoints in chain',
          ),
      })
      .optional()
      .describe(
        'Supported intents — present only when at least one module endpoint exists in the path',
      ),
    HeapId: z
      .object({
