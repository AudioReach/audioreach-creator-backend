...
import {
  DriverModuleDefinitionFetcher,
  type OverlaidDriverModuleDefinition,
} from '../../fetchers/definitions/driver-module-definitions/driver-module-definition-fetcher.js';
import {
  DriverModuleParameterDefinitionFetcher,
  type OverlaidDriverModuleParameterDefinition,
} from '../../fetchers/definitions/driver-module-definitions/driver-module-parameter-definition-fetcher.js';
...
export class DbDriverModuleDefinitionQueryService implements DriverModuleDefinitionQueryService {
  ...
  private mapSummary(
    root: OverlaidDriverModuleDefinition,
    params: OverlaidDriverModuleParameterDefinition[],
  ): BaseModuleDefinitionSummaryReadModel {
    return {
  ...
  private toParameterSummaryReadModel(
    p: OverlaidDriverModuleParameterDefinition,
  ): ParameterDefinitionSummaryReadModel {
    return {
      systemId: p.systemId,
