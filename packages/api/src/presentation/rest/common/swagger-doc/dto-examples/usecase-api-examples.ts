...
import { BaseComponentDto, KVInfo, KeyValueInfo, SystemIdsRequestDto } from '../../../modules/common/dtos/index.js';
import { ModificationAction, EndPointLink, CONN_CTRL_TYPE } from '../../../common/utils/index.js';
import { ModuleInstanceDto } from '../../../modules/module-instance/dto/module-instance.dto.js';
import { DataPortDto, PortType, PortIoType } from '../../../modules/common/dtos/data-port.dto.js';
...
import {
    ControlLinkDto,
} from '../../../modules/control-link/dto/control-link.dto.js';
...
export const SubsystemFilteredUseCaseCollectionExample = {
    getExample(): UsecaseDto[] {
        ...
        const keyvalueInfo = [
            new KeyValueInfo(0xAC_DB_F1_00, 0xF0_10_00_2E, "Subsystem", "Playback_stream_DevPP"),
            new KeyValueInfo(0xAC_00_00_00, 0xF0_10_00_34, "Subsystem", "Rx_Devices")
        ];
        const filteredKv = new KVInfo(keyvalueInfo);
        ssFilteredUcCollection.push(UsecaseDto.createFilteredGKVResponse("subsystem_1", filteredKv, ucExamples));
    ...
    getFilteredGKVExample(): UsecaseDto[] {
        ...
        collection.push(UsecaseDto.createFilteredGKVResponse("subsystem_1", filteredKv1, usecases1));

        // Second filtered group
        const keyvalueInfo2 = [
            new KeyValueInfo(0xAC_DB_F1_01, 0xF0_10_00_3A, "Subsystem", "Record_stream_DevPP"),
        ...
        collection.push(UsecaseDto.createFilteredGKVResponse("subsystem_2", filteredKv2, usecases2));
...
export const UsecaseIdentifierExample = {
    getExample(): UsecaseIdentifier {
        const keyvalueInfo = [
            new KeyValueInfo(0xA1_00_00_00, 0xA1_00_00_01, "StreamRX", "PCM_Deep_Buffer"),
            new KeyValueInfo(0xAC_00_00_00, 0xAC_00_00_02, "DevicePP_Rx", "Audio_MBDRC"),
            new KeyValueInfo(0xA2_00_00_00, 0xA2_00_00_01, "DeviceRX", "Speaker")
        ];
        const kvInfo = new KVInfo(keyvalueInfo);
        return new UsecaseIdentifier("1", UsecaseType.Regular, kvInfo, 101, "PCM_Deep_Buffer_MBDRC_Playback_Speaker", "default");
    }
};
...
export const UseCaseIdentifierCollectionExample = {
    getExample(): UsecaseIdentifier[] {
        ...
        const kvInfo = new KVInfo(keyvalueInfo);
        listOfUsecases.push(new UsecaseIdentifier("2", UsecaseType.Regular, kvInfo, 102, "PCM_Offload_MBDRC_Playback_Speaker"));
...
export const UsecaseComponentsExample = {
    getExample(): UsecaseComponentsDto {
        ...
        const moduleInstance1 = new ModuleInstanceDto("1001", 1001, 0x07_01_01_05, 'PCM Decoder');
        ...
        const moduleInstance2 = new ModuleInstanceDto("1002", 1002, 0x07_01_01_06, 'Audio MBDRC');
        ...
        const inputPort1 = new DataPortDto("2001", 2001, 'Input', PortIoType.Input, PortType.Static);
        const outputPort1 = new DataPortDto("2002", 2002, 'Output', PortIoType.Output, PortType.Static);
        moduleInstance1.dataPorts = [inputPort1, outputPort1];

        const inputPort2 = new DataPortDto("2003", 2003, 'Input', PortIoType.Input, PortType.Static);
        const outputPort2 = new DataPortDto("2004", 2004, 'Output', PortIoType.Output, PortType.Static);
        moduleInstance2.dataPorts = [inputPort2, outputPort2];

        // Add control ports to modules
        const controlPort1 = new ControlPortDto("3001", 3001, 'Control', PortType.Static, [], false);
        moduleInstance1.controlPorts = [controlPort1];

        const controlPort2 = new ControlPortDto("3002", 3002, 'Control', PortType.Static, [], false);
        const controlPort3 = new ControlPortDto("3003", 3003, 'Control', PortType.Static, [], false);
...
export const UsecaseWithComponentsExample = {
    ...
    getComplexExample(): UsecaseWithComponents {
        ...
        const keyvalueInfo = [
            new KeyValueInfo(0xA1_00_00_00, 0xA1_00_00_02, "StreamRX", "PCM_Low_Latency"),
        ...
        const eqModule = new ModuleInstanceDto("1003", 1003, 0x07_00_10_17, 'Audio EQ');
        ...
        const eqInputPort = new DataPortDto("2005", 2005, 'Input', PortIoType.Input, PortType.Static);
        const eqOutputPort = new DataPortDto("2006", 2006, 'Output', PortIoType.Output, PortType.Static);
        eqModule.dataPorts = [eqInputPort, eqOutputPort];

        // Add control ports to EQ module
        const eqControlPort1 = new ControlPortDto("3004", 3004, 'Control', PortType.Static, [], false);
        const eqControlPort2 = new ControlPortDto("3005", 3005, 'Control', PortType.Static, [], false);
...
export const UsecaseWithModificationSummaryExample = {
    ...
    getModifiedExample(): UsecaseWithModificationSummary {
        ...
        const usecaseWithComponents = UsecaseWithComponentsExample.getComplexExample();
