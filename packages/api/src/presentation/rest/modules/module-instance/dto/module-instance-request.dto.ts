...
export class BaseModuleInstanceRequest {
    ...
    @ApiProperty({
        description: 'Subgraph ID. Optional. If not provided, should create a new subgraph.',
        required: false,
    })
    @IsOptional()
    @IsNumber()
    ...
    @ApiProperty({
        description: 'Container ID. Optional. If not provided, should create a container.',
        required: false,
    })
    @IsOptional()
    @IsNumber()
...
export class DetailedModuleInstanceRequest extends BaseModuleInstanceRequest {
    @ApiProperty({ description: 'Request type', enum: ['detailed'], default: 'detailed' })
 ...
 */
export type NewModuleInstanceRequest = BasicModuleInstanceRequest | DetailedModuleInstanceRequest;
...
export class CloneModuleInstanceRequest {
    ...
    @ApiProperty({
        description: 'Target subgraph ID. If not provided, a new subgraph will be created',
        required: false,
    })
    readonly targetSubgraphId?: number;

    @ApiProperty({
        description: 'Target container ID. If not provided, a new container will be created',
        required: false,
    })
