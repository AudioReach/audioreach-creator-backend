import { Controller, Post, Body, Param, UseGuards, HttpStatus, HttpException } from '@nestjs/common';
...
export class DataLinkController extends BaseController {
    ...
    async getDataLinks(
        ...
        console.log(`Getting data-links in project ${projectId}: ${JSON.stringify(dataLinkSystemIds)}`);
    ...
    async addDataConnection(@Body() dataLinkRequest: NewDataLinkRequest): Promise<ApiResult<DataLinkDto>> {
        await Promise.resolve(); // Placeholder to satisfy linter
