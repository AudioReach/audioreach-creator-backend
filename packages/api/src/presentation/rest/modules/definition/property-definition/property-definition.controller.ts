...
export class PropertyDefinitionController {
  ...
  @ApiOperation({ summary: 'Return the list of subgraph property definitions', description: 'Return the list of subgraph property definitions based on project id' })
  @ApiParam({ name: 'projectId', description: 'Id of project', required: true })
  @ApiQuery({ name: 'propertyDefinitionId', description: 'Filter by property definition id', required: false })
      ...
      allOf: [
        { $ref: getSchemaPath(ApiResult) },
        {
          properties: {
            data: {
              type: 'array',
              items: { $ref: getSchemaPath(SubgraphPropertyDefinitionSummaryResponseDto) }
            },
          },
        },
      ],
  ...
  @ApiParam({ name: 'projectId', description: 'Id of project', required: true })
  @ApiParam({ name: 'propertySystemId', description: 'System id of subgraph property', required: true })
  @ApiOperation({ summary: 'Return subgraph property definition by property system id', description: 'Return subgraph property definition based on project id and property definition system id' })
  ...
  async getSubgraphPropertyDefinition(@Param('projectId') _projectId: string, @Param('propertySystemId') _propertySystemId: string): Promise<ApiResult<SubgraphPropertyDefinitionDetailResponseDto>> {
    // implement logic here
  ...
  @ApiParam({ name: 'projectId', description: 'Id of project', required: true })
  @ApiParam({ name: 'propertySystemId', description: 'System id of subgraph property', required: true })
  @ApiOperation({ summary: 'Delete subgraph property definition', description: 'Delete subgraph property definition based on project id and property definition system id' })
  @ApiResponse({
  ...
  async deleteSpfSubgraphPropertyDefinition(@Param('projectId') _projectId: string, @Param('propertySystemId') _propertySystemId: string): Promise<ApiResult<null>> {
    // implement logic here
  ...
  @ApiParam({ name: 'projectId', description: 'Id of project', required: true })
  @ApiQuery({ name: 'propertyDefinitionId', description: 'Filter by property definition id', required: false })
  @ApiOperation({ summary: 'Return the list of container property definitions', description: 'Return the list of container property definitions based on project id' })
  @ApiResponse({
    description: 'Successfully fetched information',
    status: HttpStatus.OK,
    schema: {
      allOf: [
        { $ref: getSchemaPath(ApiResult) },
        {
          properties: {
            data: {
              type: 'array',
              items: { $ref: getSchemaPath(ContainerPropertyDefinitionSummaryResponseDto) }
            },
          },
        },
      ],
  ...
  @ApiParam({ name: 'projectId', description: 'Id of project', required: true })
  @ApiParam({ name: 'propertySystemId', description: 'System id of container property', required: true })
  @ApiOperation({ summary: 'Return container property definition by container system id', description: 'Return container property definition based on project id and property definition system id' })
  @ApiResponse({
    description: 'Successfully fetched information',
    status: HttpStatus.OK,
    schema: {
  ...
  async getContainerPropertyDefinition(@Param('projectId') _projectId: string, @Param('propertySystemId') _propertySystemId: string): Promise<ApiResult<ContainerPropertyDefinitionDetailResponseDto>> {
    // implement logic here
  ...
  @ApiParam({ name: 'projectId', description: 'Id of project', required: true })
  @ApiParam({ name: 'propertySystemId', description: 'System id of container property', required: true })
  @ApiOperation({ summary: 'Delete container property definition', description: 'Delete container property definition based on project id and property definition system id' })
  @ApiResponse({
    status: HttpStatus.NO_CONTENT,
    description: 'Successfully deleted',
    type: ApiResult
  ...
  async deleteContainerPropertyDefinition(@Param('projectId') _projectId: string, @Param('propertySystemId') _propertySystemId: string): Promise<ApiResult<null>> {
    // implement logic here
