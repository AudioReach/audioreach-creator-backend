...
export class ModuleInfo {
  ...
  @ApiProperty({ description: 'List of container type information', type: [ContainerTypeInfo] })
  ...
  @ApiProperty({ description: 'Static control ports', type: [StaticCtrlPortInfo] })
  staticCtrlPorts!: StaticCtrlPortInfo[];

  @ApiProperty({ description: 'Dynamic intents', type: [IntentInfo] })
  dynamicIntents!: IntentInfo[];

    @ApiProperty({ description: 'Information about the module type', type: ModuleTypeInfo, required: false })
  moduleTypeInfo?: ModuleTypeInfo;

   @ApiProperty({ description: 'MDF module type', enum: MdfModuleType,required:false })
