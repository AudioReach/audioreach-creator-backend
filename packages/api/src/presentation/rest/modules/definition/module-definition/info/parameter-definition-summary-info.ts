...
export class ParameterDefinitionSummaryInfo {
    ...
    @ApiProperty({ description: 'Indicates if the parameter is deprecated', required: false })
    deprecated?: boolean;

    @ApiProperty({ description: 'Tool policy associated with the parameter', enum: ToolPolicy })
