...
export class SpfModuleDefinitionResponseDto extends BaseModuleDefinitionDto 
{
  ...
  @ApiProperty({ description: 'Indicates if the module is offloadable', required: false })
  ...
  @ApiProperty({ description: 'Direction type of the module', enum: ModuleDirectionType })
  ...
  @ApiProperty({ description: 'Custom module information', type: CustomModuleInfo, required: false })
