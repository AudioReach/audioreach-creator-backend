...
export class ModuleDefinitionController {
  ...
  @ApiOperation({ summary: 'Return the list of spf module definitions', description: 'Return the list of spf module definitions based on project id' })
  @ApiParam({ name: 'projectId', description: 'Id of project', required: true })
  @ApiQuery({ name: 'processorId', description: 'Filter by processor id', required: false })
  @ApiQuery({ name: 'moduleDefinitionId', description: 'Filter by module definition id', required: false })
  @ApiQuery({ name: 'parameterId', description: 'Filter by parameter id', required: false })
  @ApiResponse({
  ...
  @ApiResponse({
    ...
    description: 'Project, processor, module definition or parameter does not exist',
    type: ApiResult
  })
  ...
  @ApiOperation({ summary: 'Return spf module definition  by module system id', description: 'Return spf module definition based on project id and module definition system id' })
  @ApiParam({ name: 'projectId', description: 'Id of project', required: true })
  @ApiParam({ name: 'moduleSystemId', description: 'System identifier of module', required: true })
  @ApiResponse({
    description: 'Successfully fetched information',
    status: HttpStatus.OK,
    schema: {
  ...
  async getSpfModuleDefinition(@Param('projectId') _projectId: string, @Param('moduleSystemId') _moduleSystemId: string): Promise<ApiResult<SpfModuleDefinitionResponseDto>> {
    await Promise.resolve();
    return new ApiResult<SpfModuleDefinitionResponseDto>();
  }

  @Get(':projectId/definitions/modules/driver')
  @ApiOperation({ summary: 'Return the list of driver module definitions', description: 'Return the list of driver module definitions based on project id' })
  @ApiParam({ name: 'projectId', description: 'Id of project', required: true })
  @ApiQuery({ name: 'moduleDefinitionId', description: 'Filter by module definition id', required: false })
  @ApiQuery({ name: 'parameterId', description: 'Filter by parameter id', required: false })
  @ApiResponse({
  ...
  @ApiOperation({ summary: 'Return driver module definition by module system id', description: 'Return driver module definition based on project id and module definition system id' })
  @ApiParam({ name: 'projectId', description: 'Id of project', required: true })
  ...
  async getDriverModuleDefinition(@Param('projectId') _projectId: string, @Param('moduleSystemId') _moduleSystemId: string): Promise<ApiResult<DriverModuleDefinitionResponseDto>> {
    await Promise.resolve();
    return new ApiResult<DriverModuleDefinitionResponseDto>();
  }
